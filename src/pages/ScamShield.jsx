    ...
    <div className="view-section animate-fade-in">
          ...
          {!report ? (
            ...
            <div className="diagnostic-report w-full">
              <div className="safety-gauge-wrapper">
                <span className="safety-title">{f.safetyTitle}</span>
              ...
              <div className="metric-bars">
                <div className="metric-row-item">
                  <div className="bar-header"><span>{f.domainAuthority}</span><span>{report.scores.url}%</span></div>
                ...
                <div className="metric-row-item">
                  <div className="bar-header"><span>{f.paymentDemands}</span><span>{report.scores.payment}%</span></div>
                  <div className="bar-track">
                    <div 
                ...
                <div className="metric-row-item">
                  <div className="bar-header"><span>{f.urgencyIndex}</span><span>{report.scores.urgency}%</span></div>
                  <div className="bar-track">
                    <div 
              ...
              <div className="report-hints">
                <h4>{f.aiThreatTitle}</h4>
                <p className="text-xs text-secondary mt-1">
                  {report.safetyIndex < 50 ? f.threatFailMsg : f.threatPassMsg}
                </p>
              </div>
            </div>
          )}
      ...
      <section className="section-container">
        <div className="section-header text-center">
          <span className="section-tagline text-orange">{f.recentThreats}</span>
          <h2 className="section-title">{f.activeFraud}</h2>
        </div>
        <div className="scam-threats-grid">
          ...
          <div className="threat-card card-warning">
            <div className="threat-header">
              <span className="threat-badge badge-warning">{f.highBadge}</span>
              <span className="threat-date">{lang === 'en' ? 'June 2026' : lang === 'hi' ? 'जून 2026' : lang === 'ta' ? 'ஜூன் 2026' : lang === 'te' ? 'జూన్ 2026' : 'জুন ২০২৬'}</span>
            </div>
